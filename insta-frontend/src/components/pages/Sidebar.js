...
import { logoutUser, fetchUserFromToken } from '../../actions/authActions';
                    ...
                    <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                        ...
                        <div className="dropdown pb-4">
                            ...
                            <ul className="dropdown-menu dropdown-menu-dark text-small shadow">
                                ...
                                <li><Link className="dropdown-item" onClick={logout} to="">Sign out</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
export default connect(mapStateToProps,{logoutUser, fetchUserFromToken}) (Sidebar);      